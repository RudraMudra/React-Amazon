...
4. Creating Node.JS Server
   ...
   3. adding start command as node backend/server.js
   4. require express
   5. creating route for / return backend is ready.
   6. moving products.js from frontend to backend
   7. creating route for /api/products
   8. return products
   9. run npm start
